...
while True:
    ...
    try:
        ...
        tou = browser.find_element_by_xpath('/html/body/div[1]/div/div[2]/div[2]/div/div[1]/div/div/div/div[2]/div[3]/div/div[2]/div/div[1]')
        TouchActions(browser).tap(tou).perform()
        eorror=eorror+1########################################7
        time.sleep(2)
